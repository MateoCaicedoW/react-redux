        ...
        <>
            <div className='shadow-md w-full fixed top-0 left-0'>
                <div className='md:flex items-center justify-between bg-slate-800 py-4 md:px-10 px-7'>
                    ...
                    <ul className={`md:flex md:items-center md:pb-0 pt-5 md:pt-0 absolute md:static bg-slate-800 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-10 ':'top-[-490px]'}`}>
                    {
                        items.map((link)=>(
